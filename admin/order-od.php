...
if (isset($_POST['out']))
{
	...
	if(isset($_POST['check'])){
        foreach($_POST['check'] AS $value){
            ++$i;
            $res=mysqli_query($conn,"UPDATE orderp set status=4, updated_Time=CURRENT_TIMESTAMP where orderID=$value");
            if(mysqli_affected_rows($conn)==1){
                ...
                $name=$row1['cusLName'];
                $to=$row1['cusEmail'];
                $subject="Order #".$value." -Delivered";
                $message="
                    Hi $name,<br><br>

                    Your order#$value is delivered.<br> 
                    Please click the 'Received' and Rate our product in our website.<br>
                    Look forward to hear from you! :)<br>
            
                    Thanks! &#8211; FreshGrocers<br>

                    <p style='font-size: 10px;'>If you did not received the order, Please reply to this email. <br>
                    We will try to assits you ASAP.<br>
                    </p>
                ";
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Order Out of Delivery</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item"><a href="allorder.php">All Orders</a></li>
                            <li class="breadcrumb-item active"><a href="order-od.php">Order Out of Delivery</a></li>
                        </ol>
                    </div>                   
                </div>
                <!-- ============================================================== -->
                ...
                <!-- ============================================================== -->
				<?php 
                    $sql="SELECT * FROM orderp,payment,timeslot,orderstatus,customer where orderp.orderID=payment.orderID and orderp.timeslot=timeslot.timeSlot and orderstatus.osID=orderp.status and orderp.cusID=customer.cusID and orderp.status=3 ";
                    $orderpPage=10;
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <form method="post" action="order-od.php">
                                            <div><input type="submit" name="out" value="Delivered" class="btn btn-primary" style="margin-top: 20px;">
...
<?php
    if(isset($_POST['submitsearch'])){
        ...
        if(!empty(trim($keyw))){
            ...
            header("location:".SITEURL."admin/order-od.php?skeyword=".$keyw);
        }else{
            header("location:order-od.php");
        }
    }
?>
