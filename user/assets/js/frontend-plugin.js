jQuery(document).ready(function ($) {
    "use strict";
    function gnash_google_maps() {
        if ($('.gnash-google-maps').length <= 0) {
            return;
        }
        $('.gnash-google-maps').each(function () {
            var $this = $(this),
                $id = $this.attr('id'),
    ...
    function gnash_init_menu_toggle() {
        var contain = '.gnash-nav-toggle';
    ...
    // ----------gnash_custom_scrollbar-------------------
    function gnash_custom_scrollbar() {
        $('.gnash-mini-cart .minicart-items').mCustomScrollbar();
        $('.gnash-mini-cart .minicart-items').change(function () {
            $('.gnash-mini-cart .minicart-items').mCustomScrollbar();
        });
    }

    function gnash_custom_scrollbar_header_nav() {
    ...
    //------------------ Video Lightbox------------
    function gnash_video() {
        $('.quick-install').simpleLightboxVideo();
    }

    // --------------------remove_class_equal--------------------------
    function gnash_remove_class_review() {
    ...
    // -----------gnash_details_thumd--------------------
    function gnash_details_thumd_zoom() {
        /* ------------------------------------------------
         Arctic modal
         ------------------------------------------------ */
        if ($.arcticmodal) {
    ...
    /* TOGGLE */
    function gnash_dropdown() {
        $(document).on('click', '.header-control .close', function () {
            $(this).closest('.gnash-dropdown').removeClass('open');
        });
        $(document).on('click', function (event) {
            var _target = $(event.target).closest('.gnash-dropdown');
            var _allparent = $('.gnash-dropdown');
            ...
            if (_target.length > 0) {
                ...
                $('.gnash-dropdown').removeClass('open');
            }
        });
    }

    function gnash_mobile_block() {
    ...
    /* ---------------------------------------------
     TAB EFFECT
     --------------------------------------------- */
    function gnash_tab_fade_effect() {
        // effect click
        $(document).on('click', '.gnash-tabs .tab-link a', function () {
...
// ------------------owl-thumbs-----------------------------------------------
    ...
    function gnash_countdown() {
        if ($('.gnash-countdown').length > 0) {
    ...
    $(window).resize(function () {
        quickview_popup();
        kt_resizeMegamenu();
        gnash_remove_class_review();
        gnash_details_thumd_zoom();
        gnash_custom_scrollbar();
    });
    $(window).load(function () {
        newletter_popup();
    ...
    gnash_init_carousel();
    gnash_remove_class_review();
    gnash_tab_fade_effect();
    gnash_details_thumd_zoom();
    gnash_video();
    kt_resizeMegamenu();
    gnash_custom_scrollbar();
    gnash_countdown();
    gnash_init_menu_toggle();
    gnash_custom_scrollbar_header_nav();
}); 