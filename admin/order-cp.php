            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Order Completed</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item"><a href="allorder.php">All Order</a></li>
                            <li class="breadcrumb-item active"><a href="order-cp.php">Order Completed</a></li>
                        </ol>
                    </div>
                ...
                <!-- ============================================================== -->
				<?php 
                    $sql="SELECT * FROM orderp,payment,timeslot,orderstatus,customer where orderp.orderID=payment.orderID and orderp.timeslot=timeslot.timeSlot and orderstatus.osID=orderp.status and orderp.cusID=customer.cusID and orderp.status=5 ";
                    $orderpPage=25;
                                    ...
                                    <div style="float: left;">
                                        <form action="" name="sort" onchange="submit_form()" id="sort" method="post">
                                            <select name="sort" id="" class="custom-select">
                                                ...
                                                <option value="1" <?php if(isset($_GET['sort'])){ if($_GET['sort']==1){?> selected <?php }} ?>>Sort by Order ID Descending</option>
                                                <option value="2" <?php if(isset($_GET['sort'])){ if($_GET['sort']==2){?> selected <?php }} ?>>Sort by Order ID Ascending</option>
                                            </select>
                                        </form>
                                    </div>
                                </div>
...
<?php
    if(isset($_POST['submitsearch'])){
        ...
        if(!empty(trim($keyw))){
            ...
            header("location:".SITEURL."admin/order-cp.php?skeyword=".$keyw);
        }else{
            header("location:order-cp.php");
        }
    }
?>
...
<?php
    if(isset($_POST['sort'])){
        ...
        $sort=$_POST['sort'];
        $url=SITEURL."admin/order-cp.php?";
