            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Order Cancelled</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item"><a href="allorder.php">All Order</a></li>
                            <li class="breadcrumb-item active"><a href="order-cancel.php">Order Cancelled</a></li>
                        </ol>
                    </div>
                ...
                <!-- ============================================================== -->
				<?php 
                    $sql="SELECT * FROM orderp,payment,timeslot,orderstatus,customer where orderp.orderID=payment.orderID and orderp.timeslot=timeslot.timeSlot and orderstatus.osID=orderp.status and orderp.cusID=customer.cusID and orderp.status=7 ";
                    $orderpPage=25;
...
<?php
    if(isset($_POST['submitsearch'])){
        ...
        if(!empty(trim($keyw))){
            ...
            header("location:".SITEURL."admin/order-cancel.php?skeyword=".$keyw);
        }else{
...
<?php
    if(isset($_POST['sort'])){
        ...
        $sort=$_POST['sort'];
        $url=SITEURL."admin/order-cancel.php?";
